(**
 * A quick-and-dirty copy from the language package. Need to find a
 * cleaner way to share this code but I'm too much of an OCaml newb
 * to quickly figure out the correct module system invocations.
 *)
